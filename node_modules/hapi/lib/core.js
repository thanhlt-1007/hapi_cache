...
exports = module.exports = internals.Core = class {
    ...
    _initializeCache() {
        console.log('\n---Core _initializeCache---'.red);

        if (this.settings.cache) {
            console.log('\nthis.settings.cache'.yellow);
    ...
    _cachePolicy(options, _segment, realm) {
        ...
        console.log('\n---return new Catbox.Policy(options, cache.client, segment);---'.green);

        console.log('\noptions'.yellow);
        console.log(options);
        console.log('cache.client'.yellow);
        console.log(cache.client);
        console.log('segment'.yellow);
        console.log(segment);
